...
※ トトロット、ねこだるま、まっすぐなどはdeopleteの開発終了とともにサポートを終了しました。詳しくは[こちら](https://zenn.dev/shougo/articles/github-sponsors)

_長年、deopleteプラグインとしてトトロット、ねこだるま、まっすぐなどを使用していただきありがとうございました。_

_今後は、気が向いたら更新します。頻度はかなり少なくなります。_
